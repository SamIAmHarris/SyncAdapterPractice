...
public class TwitterOauthHelper {
    ...
    private static final String CONSUMER_KEY = "fNVC3vKPSivkhEYzQUik83UI4";
    private static final String CONSUMER_SECRET = "m6hxvDqkGoHpqsMf0MEHHpFNOJK6XzPACNhB3jub8ifTAqT6IT";
