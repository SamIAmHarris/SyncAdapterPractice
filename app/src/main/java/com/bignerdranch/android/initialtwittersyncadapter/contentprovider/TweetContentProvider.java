...
public class TweetContentProvider extends ContentProvider {
    ...
    private TweetsDatabaseHelper tweetsDatabaseHelper;
    ...
    public boolean onCreate() {
        tweetsDatabaseHelper = new TweetsDatabaseHelper(getContext());
        return true;
    }
    ...
    public Cursor query(Uri uri, String[] projection, String selection, String[] selectionArgs, String sortOrder) {
        ...
        switch (sUriMatcher.match(uri)) {
            case TWEET_LIST:
                ...
                cursor = tweetsDatabaseHelper.getReadableDatabase()
    ...
    public Uri insert(Uri uri, ContentValues values) {
        ...
        switch (sUriMatcher.match(uri)) {
            case TWEET_LIST:
                insertedRowId = tweetsDatabaseHelper.getWritableDatabase().insert(
    ...
    public int delete(Uri uri, String selection, String[] selectionArgs) {
        ...
        switch (sUriMatcher.match(uri)) {
            case TWEET_LIST:
                deletedCount = tweetsDatabaseHelper.getWritableDatabase().delete(
